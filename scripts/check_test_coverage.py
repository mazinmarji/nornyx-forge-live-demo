...
REQUIRED_MODULE_MINIMUMS: dict[str, int] = {
    "tests/test_approval_authentication.py": 40,
    ...
    "tests/test_clause_reachability.py": 6,
    "tests/test_reviewer_authentication.py": 22,
    "tests/test_independent_inspection.py": 15,
    "tests/test_trust_directionality.py": 8,
    "tests/test_content_binding.py": 18,
    "tests/test_subject_scope.py": 12,
    "tests/test_security_context.py": 9,
    "tests/test_evaluation_time.py": 14,
    "tests/test_execution_semantics.py": 9,
    "tests/test_skip_gate.py": 24,
    ...
    "tests/test_semantic_projection_exclusions.py": 14,
    "tests/test_task8_closure.py": 9,
    "tests/test_semantic_binding_theorem.py": 33,
    "tests/test_production_security_context.py": 18,
    "tests/test_canonical_text_writes.py": 7,
    "tests/test_approval_wiring.py": 7,
    "tests/test_approval_injection.py": 10,
    "tests/test_materialization_injection.py": 17,
    "tests/test_expiry_semantics.py": 7,
    "tests/test_pre_approval_baseline.py": 5,
    "tests/test_action_binding.py": 34,
    "tests/test_untrusted_text.py": 40,
    "tests/test_subject_completeness.py": 9,
    "tests/test_governance_integrity_authority.py": 18,
    "tests/test_artifact_authority.py": 15,
    ...
    "tests/test_dirty_tree_gate.py": 30,
